...
public class AnQaFailedProfCert extends TestBase {
	
	Xls_Reader xlsx = new Xls_Reader(Constants.testCases);
	String testname = "AnQaFailedProfCert";
...
//		pw2.uploadDocuments(data.get("pw2_2_documents"));
	...
	// QA FAILED
	@Test(priority = 18, dataProvider = "getTestData", dependsOnMethods={ "QaSupervsiserTest"})
