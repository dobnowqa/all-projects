...
public class MsNewProPw2 extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Mechanical Systems (MS); Prof. Cert.; Non-legalization; PW2
...
//		pw1.addBoilerEquipmentDevice("new_existing_both"); // no equipment device for this work type
		...
		docs.addSupportingDocuments(data.get("documents"));
