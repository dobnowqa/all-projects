...
public class BeNewStdRep extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Boiler Equipment (BE); Replacement; Standard-plan; Non-legalization
