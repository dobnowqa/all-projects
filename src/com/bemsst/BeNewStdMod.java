...
public class BeNewStdMod extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Boiler Equipment (BE); Modification; Standard-plan; Non-legalization
	...
	public void Base(Hashtable<String, String> data) {
		...
		pw1.selectDevice(data.get("device"));
