...
public class MsNew extends TestBase {
	// This test case uses DOBNOW to create an application/job/filing for new-work for Mechanical Systems (MS).
	// This test case needs to run with config.properties environment = "bemsst"
	String testname = "MsNew";
