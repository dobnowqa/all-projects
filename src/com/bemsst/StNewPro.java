...
public class StNewPro extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Structural (ST); Prof-cert.; Non-legalization
