...
public class ShNew extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Sidewalk Shed (SH); Standard-plan; Non-legalization
...
//		pw1.enterZoningCharacteristics(data.get("building_charcteristics")); // Zoning Info tab
		pw1.enterBuildingCharacteristics(data.get("building_charcteristics")); // Zoning Info tab
		pw1.saveJob("skip_number");
		asw.enterScopeOfWorkSidewalk(data.get("asw"));
