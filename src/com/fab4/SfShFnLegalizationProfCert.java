...
public class SfShFnLegalizationProfCert extends TestBase {
	
	String testname = "SfShFnLegalizationProfCert";
...
//		DobTR8Page tr8 = PageFactory.initElements(driver, DobTR8Page.class);
		...
		pw1.workTypeScaffold(data.get("new_existing_both")); // workTypeScaffold
