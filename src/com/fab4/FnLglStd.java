...
public class FnLglStd extends TestBase {
	// This test simulates a registered e-Filing account holder using DOBNOW to create a filing (aka job) for Construction Fence (FN); Standard-plan; Legalization
