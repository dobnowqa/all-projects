...
public class Pa24PlansProfCert extends TestBase {

	Xls_Reader xlsx = new Xls_Reader(Constants.testCasesesPaTpa);
	String testname = "Pa24PlansProfCert";
...
//		pa.party(data.get("party")); temporary not touch
		...
		task_form.viewAcceptDocuments(data.get("qa_super"));
	...
	public void CPEActiona(Hashtable<String, String> data) {
		task_form.qaAdmin(data.get("qa_admin"));
