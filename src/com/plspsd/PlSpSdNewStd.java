...
public class PlSpSdNewStd extends TestBase {
    // This test case uses DOBNOW to create an application/job/filing for new-work for a combination of Plumbing (PL), Sprinkler (SP) and Standpipe (SD). 
	...
	public void Base(Hashtable<String, String> data) {
		...
		PlumbingPage 		pl =   PageFactory.initElements(driver, PlumbingPage.class);
		...
		CrmDocs 			crmdocs = PageFactory.initElements(driver, CrmDocs.class);
