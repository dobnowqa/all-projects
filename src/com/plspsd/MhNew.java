...
public class MhNew extends TestBase {
	// This test case uses DOBNOW to create an application/job/filing for new-work for Mechanical Systems (MH).
	// This test case needs to run with config.properties environment = "plumbing"
	String testname = "MhNew";
...
//		tr8.energyCodeProgressInspection(data.get("tr8")); // JG 2018-12-10 there are already 4 requirement inspections by default for MH
